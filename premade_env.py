...
class GliderEnv(DefaultEnv):
    ...
    def __init__(self):
        ...
        self.observationSpace = spaces.Tuple((heading, bank, pitch, turnCoord, airspeed, vario, alt))

        self.actionSpace  = spaces.Box(low= -1.0000, high= 1.0000, shape=(3, ), dtype= np.float64)
